		...
		<div class="row hidden-xs ">
			<div class="col-sm-6">
				<div class="row">
					...
					<h3 class="contact_title col-sm-offset-2 col-sm-12 hidden-xs">Follow Rx&sup2 on...</h3>
				</div>
			...
			<div class="col-sm-6">
				<div class="row">
					<!-- Desktop Site Content -->
					<h3 class="contact_title contact_twitterFeed col-sm-12 hidden-xs">Twitter</h3>
				</div>
				<section class="contact_tweets_container">
					<!-- Twitter feed is inserted via javascript here -->
				</section>
			</div>
		</div>
	</div>		
